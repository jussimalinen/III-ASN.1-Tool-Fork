...
public:
  ...
  void GetConstraint(std::string& str) const ;
...
public:
  ...
  virtual void GenerateCplusplus(const std::string & fn, std::ostream & hdr, std::ostream & cxx, std::ostream & inl) const;
  virtual void GetConstraint(std::string& str) const;
  virtual bool ReferencesType(const TypeBase & type) const;
...
public:
  ...
  void SetOuterClassName(const std::string& oname) { outerClassName = oname; }
  void SetTemplatePrefix(const std::string& tname) { templatePrefix = tname; }
  ...
  virtual std::string GetPrimitiveType(const std::string& myName) const;
...
public:
  ...
  virtual void GenerateOperators(std::ostream & hdr, std::ostream & cxx, const TypeBase & actualType);
  virtual const char * GetAncestorClass() const;
  virtual std::string GetPrimitiveType(const std::string& myName) const { return "bool";}
  virtual void GenerateConstructors(std::ostream & hdr, std::ostream & cxx, std::ostream & inl);
};
...
public:
  RealType();
  virtual const char * GetAncestorClass() const;
  virtual std::string GetPrimitiveType(const std::string& myName) const { return "double";}
  virtual void GenerateOperators(std::ostream & hdr, std::ostream & cxx, const TypeBase & actualType);
  virtual void GenerateConstructors(std::ostream & hdr, std::ostream & cxx, std::ostream & inl);
};
...
public:
  ...
  virtual const char * GetAncestorClass() const;
  std::string GetTypeName() const;
  //virtual std::string GetPrimitiveType(const std::string& myName) const { return TypeBase::GetPrimitiveType();}
  virtual bool NeedGenInfo() const;
  virtual void GenerateCplusplus(std::ostream & hdr, std::ostream & cxx, std::ostream & inl);
  virtual void GenerateInfo(const TypeBase* type, std::ostream& hdr, std::ostream& cxx);
...
public:
  ...
  virtual const char * GetAncestorClass() const;
  std::string GetTypeName() const;
  virtual std::string GetPrimitiveType(const std::string& myName) const { return "const ASN1_STD vector<char>&";}
...
public:
  ...
  virtual std::string GetTypeName() const;
  virtual std::string GetPrimitiveType(const std::string& myName) const { return "const ASN1_STD string&";}
  virtual void GenerateConstructors(std::ostream & hdr, std::ostream & cxx, std::ostream & inl);
  virtual void GenerateOperators(std::ostream & hdr, std::ostream & cxx, const TypeBase & actualType);
  virtual bool NeedGenInfo() const;
  virtual void GenerateInfo(const TypeBase* type, std::ostream& hdr, std::ostream& cxx);
...
public:
  BMPStringType();
  virtual const char * GetAncestorClass() const;
  virtual std::string GetPrimitiveType(const std::string& myName) const { return "const ASN1_STD wstring&";}
  virtual void GenerateOperators(std::ostream & hdr, std::ostream & cxx, const TypeBase & actualType);
  virtual void GenerateConstructors(std::ostream & hdr, std::ostream & cxx, std::ostream & inl);
  virtual void GenerateInfo(const TypeBase* type, std::ostream& hdr, std::ostream& cxx);
};
...
public:
  ...
  void GenerateCplusplus(std::ostream &hdr, std::ostream & cxx, std::ostream & inl) const;
  void GenerateConst(std::ostream & hdr, std::ostream & cxx) const;
  void PrintOn(std::ostream &) const;
protected:
  StringList value;
};
...
public:
  ...
  virtual void GenerateInstanceCode(std::ostream& cxx) const =0;
  virtual void GenerateType(std::ostream& hdr, std::ostream& cxx, std::ostream& inl) const=0;
};
...
public:
  ...
  void PrintOn(std::ostream &) const;
  virtual void GenerateType(std::ostream& hdr, std::ostream& cxx, std::ostream& inl) const;
...
public:
  ...
  virtual void GenerateCplusplus(const std::string & modName,
    unsigned numFiles,
    bool verbose);
